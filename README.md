...
```js
import { xxh32 } from "https://unpkg.com/xxh32@2.0.2/dist/index.bundle.js";
import { xxh32r } from "https://unpkg.com/xxh32@2.0.2/dist/raw.bundle.js"; // for Uint8Array
```

or use dynamic import.

```js
const { xxh32 } = await import("https://unpkg.com/xxh32@2.0.2/dist/index.bundle.js");
```
...
```js
import { xxh32sr } from "https://unpkg.com/xxh32@2.0.2/dist/stream-raw.bundle.js";
```
